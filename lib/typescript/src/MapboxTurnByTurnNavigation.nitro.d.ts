...
export interface MapboxTurnByTurnNavigationMethods extends HybridViewMethods {
    ...
    addOnRouteProgressChangeListener(listener: RouteProgressChangeListener): () => void;
    addOnCancelListener(listener: OnCancelListener): () => void;
    addOnErrorListener(listener: OnErrorListener): () => void;
}
export type MapboxTurnByTurnNavigation = HybridView<MapboxTurnByTurnNavigationProps, MapboxTurnByTurnNavigationMethods>;
//# sourceMappingURL=MapboxTurnByTurnNavigation.nitro.d.ts.map